...
*/
$emailto = 'support@wiselythemes.com'; 	// Insert the email address that will receive the messages
$fromName = 'T-H-E-M-E-L-O-C-K-.-C-O-M';					// Insert a default "Name" email address (this fiel will be displayed in the email header)
$fromEmail = 'default@yourdomain.com';	// Insert a default "From" email address (this fiel will be displayed in the email header)
$subject = 'Cozy Contact Form';			// Insert a default conctact form subject
